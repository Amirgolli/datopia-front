...
export const metadata: Metadata = {
  ...
  description:
    "Datopia یک چت‌بات هوش مصنوعی است که با استفاده از یادگیری ماشین و پردازش زبان طبیعی، داده‌های شما را تحلیل می‌کند و بینش‌های ارزشمند ارائه می‌دهد.",
  keywords: [
    "Datopia",
    "چت‌بات هوش مصنوعی",
    "آنالیز داده",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Datopia AI Chatbot Preview",
      },
    ],
  },
  authors: [
