...
const faq = [
  {
    icon: Question,
    question: "دیتوپیا دقیقاً چه کاری انجام می‌دهد؟",
    answer:
      "دیتوپیا با هوش مصنوعی شما را از داشبوردهای پیچیده بی‌نیاز می‌کند و به راحتی می‌توانید داده‌ها را تحلیل و گزارش‌های تصویری دریافت کنید.",
  },
  {
    icon: ClockF,
    question: "چطور دیتوپیا به تصمیم‌گیری سریع کمک می‌کند؟",
    answer:
      "با ارائه تحلیل لحظه‌ای، نمودار و جدول، دیتوپیا داده‌ها را به بینش عملی تبدیل می‌کند تا سریع‌تر تصمیم بگیرید.",
  },
  {
    icon: Security,
    question: "می‌توانم برای امنیت بیشتر دیتوپیا را روی مدل لوکال اجرا کنم؟",
    answer:
  ...
  },
  {
    ...
    answer:
      "بله، می‌توانید قبل از خرید، نسخه آزمایشی یا دموی دیتوپیا را امتحان کنید تا با امکانات و عملکرد آن آشنا شوید.",
  },
  {
    icon: Brain,
    question: "برای کار با دیتوپیا نیاز به دانش تخصصی BI دارم؟",
    answer:
      "خیر، دیتوپیا به صورتی طراحی شده تا بدون دانش فنی هم بتوانید به راحتی داده‌ها را تحلیل و گزارش بگیرید.",
  },
  {
    icon: FileChartColumn,
    question: "چطور می‌توانم از داده‌های خود گزارش بگیرم؟",
    answer:
      "کافی است سوال خود را به صورت چت وارد کنید؛ دیتوپیا در لحظه گزارشی شامل جدول و نمودار آماده می‌کند.",
  },
];
...
const FAQ = () => {
  return (
    <div
      id="faq"
      className="min-h-screen flex items-center justify-center px-6 pb-12 xs:py-20"
    >
