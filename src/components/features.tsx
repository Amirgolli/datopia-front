...
const features = [
  ...
  },
  {
    ...
    colorS: "#2A9D90",
    description:
      "از دیتابیس تا Google Workspace و فایل‌های داخلی؛ همه به دیتوپیا وصل می‌شوند.",
  },
  {
    icon: UserA,
  ...
  },
  {
    ...
    description:
      "دیگر نیازی به داشبوردهای پیچیده نیست؛ دیتوپیا همه‌چیز را ساده می‌کند.",
  },
  {
    icon: Share2,
...
const Features = () => {
  return (
    <div id="features" className="w-full pb-12 xs:py-20 px-6">
      ...
      <div className="w-full max-w-screen-lg mx-auto mt-10 sm:mt-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {features.map((feature) => (
          <div
            key={feature.title}
            className="flex flex-col bg-background border border-[#EFB325] rounded-xl py-6 px-5"
          >
